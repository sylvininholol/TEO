...
from Construcao.utilities import read_kpf_instance, load_instances_from_directory
from carrossel_greedy import penalty_aware_greedy_construction, carousel_local_search
from Heuristicas import iterated_local_search_simple, iterated_local_search_vnd
